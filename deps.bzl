...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:cnFHelhsRQbYvanCUAbRSn/ZpkUb1HPRlQcu8YqSORQ=",
        version = "v1.13.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:wkkWotblsGVlLjXj2dpgKQAYHtXumsK/HyFugQM68Ns=",
        version = "v2.46.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:kLDiBJoGcusWS2BixGyTkF224aSCD8nLY24tj/NcTCs=",
        version = "v0.3.1",
    )
    go_repository(
